...
if __name__=='__main__':
    ...
    centerlines_comprehensive = centerline_name.union(centerline_label).distinct()
    centerlines_df = spark.createDataFrame(centerlines_comprehensive, ('physicalID','low_house_number_1','low_house_number_2','high_house_number_1','high_house_number_2','boro','street_name','even_flag'))
